    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-12 mb-20">
            <div class="card-box height-100-p pd-20 min-height-200px">
                ...
                <div class="text-center">
                    <div class="h5 mb-1">nouvelle Carte blue</div>
                    <div
                    ...
                    <a href="<?php echo base_url('new-carteblue'); ?>" class="btn btn-primary btn-lg">Commencer</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-12 mb-20">
            <div class="card-box height-100-p pd-20 min-height-200px">
                ...
                <div class="text-center">
                    <div class="h5 mb-1">Duplicata Carte blue</div>
                    <div
                        class="font-14 weight-500 max-width-200 mx-auto pb-20"
                        data-color="#a6a6a7"
                    >
        ...
        <div class="col-lg-4 col-md-12 mb-20">
            <div class="card-box height-100-p pd-20 min-height-200px">
                ...
                <div class="text-center">
                    <div class="h5 mb-1">Renouveler Carte blue</div>
                    <div
                        class="font-14 weight-500 max-width-200 mx-auto pb-20"
                        data-color="#a6a6a7"
                    >
